...
## Note
az functionapp create --resource-group kj-dev-test --name kjcontainerappsfnc `
--environment managedEnvironment-kjdevtest-b41d `
--storage-account kjdevtestcontainerapp `
--functions-version 4 `
--runtime dotnet-isolated `
--image kjcontainerregistry.azurecr.io/functionapp1:20230603070532 
